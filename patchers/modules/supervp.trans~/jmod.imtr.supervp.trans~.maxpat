...
, 			{
				"box" : 				{
					"annotation" : "Remixing of the transient component of the signal.",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-21",
					"maxclass" : "flonum",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 560.0, 330.0, 590.0, 31.0 ],
					"text" : "jcom.parameter remix/transient @type decimal @range/bounds 0. 1. @range/clipmode none @repetitions/allow 0 @dataspace gain @dataspace/unit db @description \"Remixing of the transient component of the signal.\"",
					"varname" : "hue_angle[5]"
				}
...
, 			{
				"box" : 				{
					"annotation" : "Remixing of the noise component of the signal.",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-18",
					"maxclass" : "flonum",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 560.0, 280.0, 572.0, 31.0 ],
					"text" : "jcom.parameter remix/noise @type decimal @range/bounds 0. 1. @range/clipmode none @repetitions/allow 0 @dataspace gain @dataspace/unit db @description \"Remixing of the noise component of the signal.\"",
					"varname" : "hue_angle[4]"
				}
...
, 			{
				"box" : 				{
					"annotation" : "Remixing of the sinusodial component of the signal.",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-15",
					"maxclass" : "flonum",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 560.0, 230.0, 571.0, 31.0 ],
					"text" : "jcom.parameter remix/sinus @type decimal @range/bounds 0. 1. @range/clipmode none @repetitions/allow 0 @dataspace gain @dataspace/unit db @description \"Remixing of the sinusodial component of the signal.\"",
					"varname" : "hue_angle[3]"
				}
...
, 			{
				"box" : 				{
					"annotation" : "Maximal frequency for spectral envelope transposition. Keep max_freq just above the expected frequencies of the source signal - or use a pitch tracker.",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-12",
					"maxclass" : "flonum",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 560.0, 165.0, 601.0, 43.0 ],
					"text" : "jcom.parameter spectral_envelope/max_freq @type decimal @range/bounds -12. 12. @range/clipmode none @repetitions/allow 1 @dataspace time @dataspace/unit midi @description \"Maximal frequency for spectral envelope transposition. Keep max_freq just above the expected frequencies of the source signal - or use a pitch tracker.\"",
					"varname" : "hue_angle[2]"
				}
...
, 			{
				"box" : 				{
					"annotation" : "Transposition of spectral envelope.",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-5",
					"maxclass" : "flonum",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 560.0, 115.0, 573.0, 31.0 ],
					"text" : "jcom.parameter spectral_envelope/transpose @type decimal @range/bounds -12. 12. @range/clipmode none @repetitions/allow 1 @dataspace time @dataspace/unit midi @description \"Transposition of spectral envelope.\"",
					"varname" : "hue_angle[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 560.0, 80.0, 579.0, 31.0 ],
					"text" : "jcom.parameter transpose @type decimal @range/bounds -12. 12. @range/clipmode none @repetitions/allow 1 @dataspace time @dataspace/unit midi @description \"Pitch transposition.\"",
					"varname" : "hue_angle"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 85.0, 475.0, 80.0, 19.0 ],
					"text" : "jcom.out~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 85.0, 506.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "signal", "signal" ],
					"patching_rect" : [ 30.0, 445.0, 133.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 115.0, 506.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 145.0, 510.0, 108.0, 19.0 ],
					"text" : "---signal outputs---"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 184.5, 417.0, 39.5, 417.0 ],
					"source" : [ "obj-8", 2 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "jalg.imtr.supervp.trans~.maxpat",
				"bootpath" : "/Users/lossius/dev/Jamoma/UserLib/Jamoma.Ircam.IMTR/supervp.trans~",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
