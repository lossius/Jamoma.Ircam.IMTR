...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 447.0, 326.0, 70.0, 19.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					"annotation" : "downsampling factor, should be at least 2 according to yin~ documentation",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-12",
					"maxclass" : "newobj",
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 447.0, 279.0, 56.0, 19.0 ],
					"text" : "route set"
				}
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 447.0, 303.0, 59.5, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 299.0, 427.0, 150.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 122.0, 46.0, 100.0, 19.0 ],
					"text" : "update Rate [Hz]:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 287.0, 337.0, 150.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 122.0, 24.0, 83.0, 19.0 ],
					"text" : "minimal Pitch:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 283.0, 258.0, 62.0, 31.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 22.0, 88.0, 19.0 ],
					"text" : "Downsampling:"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 374.0, 405.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 222.0, 46.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 368.0, 355.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 222.0, 24.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 448.0, 245.0, 572.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 345.0, 268.0, 100.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 85.0, 22.0, 40.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 176.0, 379.0, 80.0, 4.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 212.0, 7.0, 80.0, 4.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 399.0, 210.0, 40.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 83.0, 45.0, 38.0, 19.0 ],
					"triscale" : 0.9,
					"varname" : "ParameterA"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 331.0, 209.0, 62.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 46.0, 62.0, 19.0 ],
					"text" : "Threshold:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 94.0, 417.0, 73.0, 19.0 ],
					"text" : "jcom.out~ 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 15.0, 170.0, 414.0, 19.0 ],
					"text" : "jcom.hub @module_type audio @description \"This module wraps IRCAM's yin~\"",
					"varname" : "jcom.hub"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 74.0, 385.0, 62.0, 19.0 ],
					"text" : "jalg.yin~"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "jalg.yin~.maxpat",
				"bootpath" : "/Users/nilspeters/Documents/gits/Jamoma/UserLib/Jamoma.Ircam.IMTR/yin~",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
